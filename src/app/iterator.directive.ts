import { ChangeDetectorRef, DefaultIterableDiffer, Directive, Input, IterableDiffers, TemplateRef, ViewContainerRef, ViewRef } from "@angular/core";
        ...
        if (changes != null) {
            ...
            changes.forEachRemovedItem(removal => {
                ...
                if (context != null) {
                    ...
                    this.views.set(removal.trackById, context);
                }
            });
            if (removals) {
                let index=0;
